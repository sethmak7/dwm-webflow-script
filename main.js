...
//     0.03, 6.55, 1,
// ];
let defaultViewMatrix = [0.98,0.03,-0.2,0,-0.02,1,0.02,0,0.19,-0.02,0.98,0,2.48,0.13,6.78,1];
...
const modelIdView = document.getElementById('3dview');
const modelId = modelIdView.getAttribute('modelId');
    const url = new URL("https://assets.dwm-dev.collectiv.co/gs/" + modelId + ".splat");
...
loadingOverlayDiv.className = 'loading-overlay';
loadingOverlayDiv.id = 'loadingOverlay';
loadingOverlayDiv.style.display = 'none'; // initially hidden
...
circleBg.setAttribute('class', 'progress-ring__circle bg');
circleBg.setAttribute('stroke-width', '4');
circleBg.setAttribute('fill', 'transparent');
circleBg.setAttribute('r', '52');
circleBg.setAttribute('cx', '60');
circleBg.setAttribute('cy', '60');

//Create the foreground circle
const circleFg = document.createElementNS(svgNS, 'circle');
circleFg.setAttribute('class', 'progress-ring__circle fg');
circleFg.setAttribute('stroke-width', '4');
circleFg.setAttribute('fill', 'transparent');
circleFg.setAttribute('r', '52');
...
// Append SVG to overlay div
loadingOverlayDiv.appendChild(svg);
...
// Create the dialog element with the 'open' attribute and id
